...
const Page = () => {
  ...
  return (
    <div ref={container} className='w-full h-screen bg-[var(--bgc)]'>
      <div className='lines_svg'>
...
const bottomLeftPaths = [
  { d: "M26 0V400C26 510.457 115.543 600 226 600H321", stroke: "#121212", width: 52, length: 809.204 },
