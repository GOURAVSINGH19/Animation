...
const TEXTUREMAP = '/raw-2.png';
const DEPTHMAP = '/depth-2.png';
const EDGEMAP = '/edge-2.png';
        ...
        <div className='text-white'>
            ...
            <div className="h-svh">
                <div className="h-svh uppercase items-center w-full absolute z-60 pointer-events-none px-10 flex justify-center flex-col">
                    <div
                        className="text-4xl md:text-7xl xl:text-8xl 2xl:text-9xl font-serif"
                    >
